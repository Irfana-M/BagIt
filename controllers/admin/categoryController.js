...
const categoryInfo = async (req, res) => {
    ...
    const addCategoryOffer = async(req,res)=>{
        ...
        try {
           ...
           if(hasProductOffer){
            return res.json({status:false,message:"Products within this category alreadyproduct offers"})
           } 
    ...
    module.exports = {categoryInfo,addCategory,addCategoryOffer,removeCategoryOffer,getListCategory,
